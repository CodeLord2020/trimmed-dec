...
def start_sentiment_analysis_BERT(query):
    try:
        comments_max = 50
        limit = 5
        comments = []
        ...
        sentiments_data_bert = analyze_sentiment_with_bert(comments)
        #top_comments = get_top_comments(sentiments_data_bert, comments)
    ...
    return sentiments_bert_plot, comments_wordcloud
